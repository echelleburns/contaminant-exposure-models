...
create_plots(data = scaled, type = "in Muscle Tissue", contam = "DDT", 
             color = "darkslategray", path = "../../figures/VR/raw_figures/", 
             file = "ddt_muscle")

# scale for ks test

ddt_tissue <- scale_for_ks(spp = "VR", file = "VR-DDT_CDE-estimates.csv", 
                  data = scaled)
} 
...
for( file in list_files ) { 
  ...
  create_plots(data = scaled, type = "without behavioral data", contam = "DDT", 
             color = "dodgerblue4", path = "../../figures/VR/raw_figures/", 
...
pcb_muscle <- scale_for_ks(spp = "VR", file = "VR-PCB_CDE-estimates.csv", 
                  data = scaled)
} 
