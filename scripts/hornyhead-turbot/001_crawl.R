...
# Save all csvs 
write.csv(model_est, "data/crawl/HT_model_estimates.csv", row.names=FALSE)
write.csv(twomin, "data/crawl/HT_2min-interpolations.csv", row.names = F)
write.csv(fivemin, "data/crawl/HT_5min-interpolations.csv", row.names = F)
...
# Read in files
model_est <- read.csv("data/crawl/HT_model_estimates.csv")
twomin <- read.csv("data/crawl/HT_2min-interpolations.csv")
fivemin <- read.csv("data/crawl/HT_5min-interpolations.csv")

# Fish to be redone
redo_list <- c("A69-1601-46728")
